...
public class GraphicsDisplay extends JPanel {
    ...
    public GraphicsDisplay() {
        ...
        //Чтобы поменять бекграунд на красный тут setBackground(Color.RED);
    ...
    public void paintComponent(Graphics g) {
        //Эта функция отрисовывает всё что мы видим
    ...
    private void paintGraphics(Graphics2D canvas) {
        ...
        //Цвет рисовкли при измениение бекграунда надо поменять на белыйь canvas.setColor(Color.WHITE);
    ...
    protected void paintAxis(Graphics2D canvas) {
        ...
        if (minY<=0.0 && maxY>=0.0) {
            ...
            //раскоментить чтобы добавить ноль в начало координат
